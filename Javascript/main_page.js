...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Optional: Add a button or area to trigger opening
  const openTrigger = document.querySelector('.top-section'); // Adjust selector as needed
  if (openTrigger) {
      openTrigger.addEventListener('click', openContainer);
  }

  // Automatically open container after a short delay
