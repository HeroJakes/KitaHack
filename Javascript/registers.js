...
if (manualSubmitBtn) {
  manualSubmitBtn.addEventListener("click", async (event) => {
    ...
    if (!fullnameEl || !positionEl || !emailEl || !passwordEl || !phoneNumberEl) {
...
if (moreDataForm) {
  ...
  moreDataForm.addEventListener("submit", async (e) => {
    ...
    // On the additional data page, we need fullname, position, phone_number, and profile picture
    const fullnameEl = document.getElementById("fullname");
    const positionEl = document.getElementById("position");
    const phoneNumberEl = document.getElementById("phone_number");
    const profilePictureEl = document.getElementById("profilePicture");
    ...
    if (!fullnameEl || !positionEl || !phoneNumberEl) {
